import { GoTelescope, GoSearch, GoBook, GoPerson } from "react-icons/go";
    ...
    >
      <div className="w-1/4 h-full flex items-center justify-center pb-1">
        ...
        >
          <GoTelescope
            title="Explore"
            className="text-2xl text-black-tertiary group-hover:text-pink-light dark:text-gray-dark-100 dark:group-hover:text-pink-dark"
          />
        </Link>
      </div>
